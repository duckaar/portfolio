# Аналіз процесу підтвердження замовлень, доставки та RFM-сегментації в e-commerce
...
- **RFM-аналіз:** розрахунок метрик Recency, Frequency, Monetary та сегментація клієнтів
...
## Аналіз 3: RFM-сегментація клієнтів

### Мета аналізу

Метою було сегментувати клієнтів на основі їх поведінки, використовуючи підхід RFM (Recency, Frequency, Monetary).

Це дозволяє виділити найбільш цінних клієнтів.

### Підхід

Для кожного клієнта було розраховано:

- **Recency** — кількість днів з останньої покупки  
- **Frequency** — кількість замовлень  
- **Monetary** — загальна сума витрат  

Далі:

- застосовано **window functions** для ранжування клієнтів  
- використано **NTILE(10)** для побудови скорів  
- сформовано загальний **RFM score**  
- виконано сегментацію клієнтів (Champions, At Risk тощо)

### Візуалізація

![RFM Dashboard](visuals/Task_3_1.png)

### Основні висновки

- Найбільші сегменти клієнтів — **Promising, Loyal VIPs та Potential Loyalists** (~19K кожен)  
- Значна частина клієнтів відноситься до **Champions (~15K)**, що свідчить про сильну базу лояльних клієнтів  
- Сегмент **At Risk (~8K)** потребує уваги, оскільки ці клієнти можуть припинити покупки  
- Сегмент **Lost/Inactive є відносно невеликим (~1K)**  
