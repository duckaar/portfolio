...
- проаналізовано час підтвердження замовлень і виявлено аномальні випадки
- досліджено вплив відстані між продавцем і покупцем на час доставки
- розраховано відстань між точками за формулою Haversine
- виконано RFM-аналіз і сегментацію клієнтів
- побудовано візуалізації результатів у Power BI

У роботі використано SQL (PostgreSQL), window functions, CTE, агрегатні та математичні функції, а також Power BI для візуалізації та фільтрації даних.
